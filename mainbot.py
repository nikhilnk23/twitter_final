...
while True:
    user = api.get_user('NikhilK33221441')
    api.update_profile(name=f'Nikhil|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Nikhil|{follower_count(user)} Followers')
